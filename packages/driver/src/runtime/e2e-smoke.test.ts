...
export async function setupE2E(
  ...
  const controller: ClientController = {
    ...
    sendCommand(cmd: import("@tmuxcc/protocol").WireCommand): void { inputApi.sendCommand(cmd); },
  };
      ...
      async () => {
        ...
        try {
          ...
          controller.sendCommand({
            ...
            windowId: windowId as import("@tmuxcc/protocol").WindowId,
            on: true,
          });
          ...
          const syncModel = await waitFor(
            () => {
              ...
              const win = m.windows.get(windowId as import("@tmuxcc/protocol").WindowId);
