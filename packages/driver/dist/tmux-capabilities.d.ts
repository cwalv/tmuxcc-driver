 ...
 */
export declare const MINIMUM_TMUX_VERSION = "3.0";
 ...
 * format.
 */
export declare function parseTmuxVersion(output: string): string | null;
/**
 ...
 */
export declare function compareTmuxVersion(a: string, b: string): number;
/**
 ...
 */
export declare function deriveCapabilities(version: string): TmuxCapabilityMap;
/**
 ...
 */
export declare function probeTmuxCapabilities(): TmuxCapabilityState | null;
//# sourceMappingURL=tmux-capabilities.d.ts.map