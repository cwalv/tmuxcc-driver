 ...
 */
export declare const EFFECT_IDS_FORMAT = "#{pane_id} #{window_id}";
/**
 ...
 */
export declare function parseEffectIds(body: string): EffectIds | null;
/**
 ...
 */
export declare function sendKeysHex(paneId: number, bytes: Uint8Array): string;
/**
 ...
 */
export declare function refreshClientSize(cols: number, rows: number): string;
/**
 ...
 */
export declare function refreshClientWindowSize(windowId: number, cols: number, rows: number): string;
 ...
 */
export declare function refreshClientFlow(paneId: number, state: PaneFlowState): string;
/**
 ...
 */
export declare const LIST_WINDOWS_DEFAULT_FORMAT = "#{session_name}\t#{window_id}\t#{window_name}\t#{window_width}\t#{window_height}\t#{window_layout}\t#{window_flags}\t#{?window_active,1,0}\t#{window_visible_layout}";
/**
 ...
 */
export declare function listWindows(format?: string, sessionId?: number): string;
/**
 * Default format string for list-panes.
 *
 * Tab-separated fields capturing pane identity and geometry.
 */
export declare const LIST_PANES_DEFAULT_FORMAT = "#{pane_id}\t#{window_id}\t#{pane_index}\t#{pane_width}\t#{pane_height}\t#{pane_top}\t#{pane_left}\t#{?pane_active,1,0}\t#{pane_pid}\t#{pane_current_command}";
 ...
 */
export declare function listPanes(target?: string | ListPanesSessionOptions, format?: string): string;
 ...
 */
export declare function capturePane(paneId: number, opts?: CapturePaneOptions): string;
/**
 ...
 */
export declare const PANE_GRID_FACTS_FORMAT = "#{cursor_x},#{cursor_y},#{history_size},#{pane_height}";
/**
 ...
 */
export declare function displayMessagePane(paneId: number, format: string): string;
 ...
 */
export declare function newWindow(opts?: NewWindowOptions): string;
/**
 ...
 */
export declare function setOption(scope: SetOptionScope, option: string, value: string): string;
/**
 ...
 */
export declare function setOptionForWindow(windowId: number, option: string, value: string): string;
/**
 ...
 */
export declare function showOptionsForWindow(windowId: number, option: string): string;
/**
 ...
 */
export declare function setOptionForPane(paneId: number, option: string, value: string): string;
/**
 ...
 */
export declare function showOptionsForPane(paneId: number, option: string): string;
/**
 ...
 */
export declare function unsetOptionForPane(paneId: number, option: string): string;
/**
 ...
 */
export declare function unsetOptionForWindow(windowId: number, option: string): string;
/**
 ...
 */
export declare function setOptionForSession(sessionName: string, option: string, value: string): string;
/**
 ...
 */
export declare function unsetOptionForSession(sessionName: string, option: string): string;
 ...
 */
export declare function splitWindow(paneId: number | undefined, orientation: SplitOrientation, opts?: SplitWindowOptions): string;
/**
 ...
 */
export declare function selectLayout(windowId: number, layoutString: string): string;
/**
 ...
 */
export declare function killWindow(windowId: number): string;
 ...
 */
export declare function breakPane(paneId: number, opts?: BreakPaneOptions): string;
/**
 ...
 */
export declare function setWindowSizeManual(windowId: number): string;
/**
 ...
 */
export declare function setWindowSizeDefault(windowId: number): string;
/**
 ...
 */
export declare function resizeWindow(windowId: number, cols: number, rows: number): string;
/**
 ...
 * distribution).
 */
export declare function resizePane(paneId: number, cols: number, rows: number): string;
/**
 ...
 */
export declare function refreshClientSubscribeWindows(name: string, format: string): string;
/**
 * Register a tmux control-mode subscription that polls a format string for
 ...
 */
export declare function refreshClientSubscribePanes(name: string, format: string): string;
