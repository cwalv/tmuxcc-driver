 ...
 */
export function parseEffectIds(body) {
 ...
 */
export function sendKeysHex(paneId, bytes) {
    if (bytes.length === 0) {
 ...
 */
export function refreshClientSize(cols, rows) {
 ...
 */
export function refreshClientWindowSize(windowId, cols, rows) {
 ...
 */
export function refreshClientFlow(paneId, state) {
 ...
 */
export const LIST_WINDOWS_DEFAULT_FORMAT = "#{session_name}\t#{window_id}\t#{window_name}\t#{window_width}\t#{window_height}\t#{window_layout}\t#{window_flags}\t#{?window_active,1,0}\t#{window_visible_layout}";
/**
 ...
 */
export function listWindows(format, sessionId) {
 ...
 */
export const LIST_PANES_DEFAULT_FORMAT = "#{pane_id}\t#{window_id}\t#{pane_index}\t#{pane_width}\t#{pane_height}\t#{pane_top}\t#{pane_left}\t#{?pane_active,1,0}\t#{pane_pid}\t#{pane_current_command}";
/**
 ...
 */
export function listPanes(target, format) {
 ...
 */
export function capturePane(paneId, opts) {
    const parts = [`capture-pane -t %${paneId} -p`];
    if (opts?.escapes) {
        parts.push("-e");
    }
    if (opts?.joinWrapped) {
 ...
 */
export const PANE_GRID_FACTS_FORMAT = "#{cursor_x},#{cursor_y},#{history_size},#{pane_height}";
/**
 ...
 */
export function displayMessagePane(paneId, format) {
 ...
 */
export function setOption(scope, option, value) {
    let flags;
    switch (scope) {
        case "session":
            flags = "";
 ...
 */
export function setOptionForWindow(windowId, option, value) {
 ...
 */
export function showOptionsForWindow(windowId, option) {
 ...
 */
export function setOptionForPane(paneId, option, value) {
 ...
 */
export function showOptionsForPane(paneId, option) {
 ...
 */
export function unsetOptionForPane(paneId, option) {
 ...
 */
export function unsetOptionForWindow(windowId, option) {
 ...
 */
export function setOptionForSession(sessionName, option, value) {
 ...
 */
export function unsetOptionForSession(sessionName, option) {
 ...
 */
export function splitWindow(paneId, orientation, opts) {
 ...
 */
export function selectLayout(windowId, layoutString) {
 ...
 */
export function breakPane(paneId, opts) {
    const parts = ["break-pane -d"];
    if (opts?.printIds === true) {
        parts.push(`-P -F ${quoteArg(EFFECT_IDS_FORMAT)}`);
    }
    parts.push(`-s %${paneId}`);
 ...
 */
export function setWindowSizeManual(windowId) {
 ...
 */
export function setWindowSizeDefault(windowId) {
 ...
 */
export function resizeWindow(windowId, cols, rows) {
 ...
 * distribution).
 */
export function resizePane(paneId, cols, rows) {
 ...
 */
export function refreshClientSubscribeWindows(name, format) {
 ...
 */
export function refreshClientSubscribePanes(name, format) {
    // The argument to -B is `name:%*:format`. Single-quote the entire argument
