...
import { PaneNotifyScanner, parseOscContent } from "./notify-scanner.js";
// ---------------------------------------------------------------------------
// Byte builders
// ---------------------------------------------------------------------------
const ESC = 0x1b;
...
describe("notify-scanner: interleaved with output", () => {
    it("plain output around a bell and an OSC 9 yields both, in order", () => {
        const chunk = seq("hello world\n", BEL, "more output ", ESC, "]9;ping", BEL, " trailing");
...
//# sourceMappingURL=notify-scanner.test.js.map