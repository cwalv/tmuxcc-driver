 ...
 */
export function compareTmuxVersion(a, b) {
 ...
 */
export function deriveCapabilities(version) {
    const gte = (floor) => compareTmuxVersion(version, floor) >= 0;
    return {
        windowSize: gte("2.9"),
 ...
 */
export function probeTmuxCapabilities() {
...
//# sourceMappingURL=tmux-capabilities.js.map