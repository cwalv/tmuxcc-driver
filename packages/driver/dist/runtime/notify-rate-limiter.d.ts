...
export declare class PaneNotifyRateLimiter {
     ...
     */
    allow(kind: PaneNotifyKind, nowMs?: number): boolean;
}
/**
 ...
 * expected and silent.
 */
export declare function isTier1NotifyKind(kind: PaneNotifyKind): boolean;
//# sourceMappingURL=notify-rate-limiter.d.ts.map