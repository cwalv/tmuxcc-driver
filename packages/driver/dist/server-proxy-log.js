 ...
 */
export function openServerProxyLog(logPath) {
    let fd;
    try {
 ...
 */
export function installStderrMirror(log) {
    ...
    const teeWrite = (chunk, encodingOrCb, cb) => {
        log.append(chunk);
...
//# sourceMappingURL=server-proxy-log.js.map