...
export declare function paneId(raw: string): PaneId;
/** @internal Mint a WindowId from a raw string (session-proxy use only). */
export declare function windowId(raw: string): WindowId;
...
export declare function connectionId(raw: string): ConnectionId;
export {};
