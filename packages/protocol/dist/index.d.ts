...
export type { TemplatePane, TemplateHSplit, TemplateVSplit, TemplateNode, WindowTemplate, SessionTemplate, TemplateApplyResult, } from "./session-template.js";
