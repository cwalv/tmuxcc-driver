 ...
 */
export type ServerProxyErrorCode = "protocol.unknown-message" | "protocol.malformed" | "protocol.version-mismatch" | "session.not-found" | "session.name-taken" | "template.invalid" | "tmux.unavailable" | "internal" | (string & Record<never, never>);
/**
