 ...
 */
export type ServerProxyCommand = SessionClaimCommand | SessionCreateCommand | SessionCreateUniqueCommand | SessionDestroyCommand | SessionApplyTemplateCommand | SessionFreezeTemplateCommand | ServerProxyInfoCommand | ServerProxySetMetricsHttpCommand | SessionTopologyCommand;
/**
 ...
 */
export type ServerProxyErrorCode = "protocol.unknown-message" | "protocol.malformed" | "protocol.version-mismatch" | "session.not-found" | "session.name-taken" | "template.invalid" | "tmux.unavailable" | "tmux.capability-required" | "metrics.bind-invalid" | "server-proxy.shutting-down" | "internal" | (string & Record<never, never>);
/**
