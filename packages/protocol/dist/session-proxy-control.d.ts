 ...
 */
export type WireErrorCode = "protocol.unknown-message" | "protocol.malformed" | "protocol.version-mismatch" | "session.unavailable" | "internal" | (string & Record<never, never>);
/**
