 ...
 * ```
 */
export function isCommandError(err, code) {
 ...
 */
export function requiredCapability(err) {
    const d = err.details;
    if (typeof d !== "object" ||
        d === null ||
 ...
 */
export function toCommandFailure(err) {
    const base = { ok: false, code: err.code, message: err.message };
