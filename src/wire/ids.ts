/**
 * Shared primitive types for the tmuxcc wire protocol.
 *
 * These identifiers are used by BOTH the control plane (this bead, tc-auj) and
 * the data plane (tc-2mq, length-prefixed byte framing). Put any type that
 * both planes reference here so they share a single definition.
 *
